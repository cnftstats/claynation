...
<ul id="sidebar_ul">
  ...
  <li id="currentProject"><a href="https://cnftstats.github.io/claynation">Clay Nation</a></li>
...
X[price %between% c(0, 1999),      price_range := trunc(price/250)*250]
X[price %between% c(2000, 4999),   price_range := trunc(price/500)*500]
X[price %between% c(5000, 9999),   price_range := trunc(price/1000)*1000]
X[price %between% c(10000, 29999), price_range := trunc(price/10000)*10000]
X[price >= 30000,                  price_range := 30000]
...
X[price_range %between% c(0, 1999),    x_label := paste0(price_range, "-", price_range + (250-1))]
...
X[price_range %between% c(10000, 29999), x_label := paste0(price_range, "-", price_range + (10000-1))]
X[price_range >= 30000,                x_label := "30000+"]
...
X[, img := sprintf("https://raw.githubusercontent.com/cnftstats/images/main/claynation/claynation%s_large.png", asset_number)]
...
datatable(X, class = 'compact stripe hover',
          options = list(dom = "t",
                         ...
                         info = FALSE,
                         columnDefs = list(list(className = 'dt-right', targets = "_all"))),
          colnames = c("Rank range", "Asset", "Price", "Market"),
          rownames = FALSE,
          escape = FALSE) %>%
  formatStyle(columns = 1:ncol(X), fontSize = '90%')
```
